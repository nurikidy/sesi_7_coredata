...
class MemberProvider {
            ...
            do {
                ...
                for result in results {
                    let member = MemberModel(
                        ...
                        profession: result.value(forKey: "profession") as? String,
                        about: result.value(forKey: "about") as? String,
    ...
    func getMaxId(completion: @escaping(_ maxId: Int) -> Void) {
        ...
        taskContext.performAndWait {
            let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "Member")
            let shortDescriptor = NSSortDescriptor(key: "id", ascending: false)
